// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["tyyszy", "dyttzy", "wwzy", "bfzy", "dbzy"]'); // 默认选中黑木耳和豆瓣资源
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 仅选择黑木耳源和豆瓣资源
        selectedAPIs = ["tyyszy", "dyttzy", "wwzy", "bfzy", "dbzy"];
...
function initAPICheckboxes() {
    ...
    if (!HIDE_BUILTIN_ADULT_APIS) {
        ...
        adultTitle.innerHTML = `敏感资源采集站 <span class="adult-warning">
